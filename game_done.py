...
def find_p(option):
    ...
    if option == '1':
        print('\nCongratulations you have opend the door and beat the puzzle! Take the princess through back gate, there is a hores waiting for you.\n')
    elif option == '2':
        print('\nYou have chosen the wrong option go back and chose the first option.')
        find_p("")
shield = """
                                   .-.
                          {{#}}
...
def key():
    option1 = str(
        input("You are now upstairs, you see two metals doors that resemble metal bars, through them you can see there is a locked chest and the other room is the princess, she seems passed out and tied up, this must tbe place that the monster was talking about.\n\n1. Approach the chest\n2. Approach the princess\nWhat will you do? : "))
    if option1 == '1':
        ...
        get_guess()
        #print("Congratulations, the chest has opened! you claim the key and make your way back.\n\nYou untie the princess and she wakes up, she thanks you greatly and you have completed your mission!")
        find_p("")
    elif option1 == "2":
