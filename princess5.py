...
import winsound # used to play sound


winsound.PlaySound('sound.wav', winsound.SND_FILENAME | winsound.SND_ASYNC) # main music
print("\033[30;47m")
princess = """
 ▄▄▄▄▄▄▄▄▄▄▄  ▄▄▄▄▄▄▄▄▄▄▄  ▄▄▄▄▄▄▄▄▄▄▄  ▄▄        ▄  ▄▄▄▄▄▄▄▄▄▄▄  ▄▄▄▄▄▄▄▄▄▄▄  ▄▄▄▄▄▄▄▄▄▄▄  ▄▄▄▄▄▄▄▄▄▄▄ 
▐░░░░░░░░░░░▌▐░░░░░░░░░░░▌▐░░░░░░░░░░░▌▐░░▌      ▐░▌▐░░░░░░░░░░░▌▐░░░░░░░░░░░▌▐░░░░░░░░░░░▌▐░░░░░░░░░░░▌          .                 .
...
print("\033[30;47m")
print("\n")
print('{} you are riding through the forest on your horse tasked with locating a princess, rumours are she is trapped in a nearby castle, you are on your way there right now.'.format(name.capitalize()))
time.sleep(3)
...
def short_cut(text, monster): # function for the player chosen shortcut option
    winsound.PlaySound('fight.wav', winsound.SND_FILENAME | winsound.SND_ASYNC) # fight music
    time.sleep(1)
    print(text)
    time.sleep(2)
    print(monster)
...
# Choices and input if statements
    print("\033[31;47m")
    print("# You will now roll a number from 1-100, if you roll below 20 your chances of survival vanish. Good luck.#")
    print("\033[30;47m")
    choice1 = str(input( "1. Attack\n2. Defend\nWhat will you do? : "))
    if choice1 == "1" and result > 20:
        time.sleep(1)
        print("You have rolled: '{}', Your attack kills the monster! The monsters last words were information that 'the princess is locked in a room upstairs in the castle.'\n".format(result))
        time.sleep(1)
        print("You are now back on track riding towards the castle!")
        time.sleep(2)
        print("\033[34;47m")
        print("""
                              A
...
def find_p(option):
    ...
    if option == '1':
        print('\nCongratulations! you have freed the princess and beat the game!\nThere is a horse waiting for you and the princess behind the castle.\n')
        time.sleep(1)
        print("\033[36;47m")
        horse_ascii = """
