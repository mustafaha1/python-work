...
def key():
    option1 = str(input("You are now upstairs, you see two metals doors that resemble metal bars, through them you can see there is a locked chest and the other room is the princess, she seems passed out and tied up, this must tbe place that the monster was talking about.\n\n1. Approach the chest\n2. Approach the princess\nWhat will you do? : "))
    if option1 == '1':
        chest_ascii = """
         __________
        /\____;;___
